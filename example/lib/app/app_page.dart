      ...
      body: Builder(builder: (context) {
        ...
        return SafeArea(
          child: Column(
            ...
            children: [
              ElevatedButton(onPressed: () => cubit.showMessage('Message'), child: const Text('Show Dialog')),
              const SizedBox(height: 20),
              ElevatedButton(onPressed: () => cubit.showLoading(), child: const Text('Show Loading')),
            ],
          ),
        );
      }),
